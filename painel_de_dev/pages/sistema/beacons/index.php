...
<html lang="pt-br">
	...
	<div class="page-content" id="page-content">
		...
		<div class="page-tab" id="tab1">
			...
			<!-- Listar -->
			<?php require 'pages/sistema/beacons/listar.php' ?>
			<!-- Listar -->
		...
		<div class="page-tab hide" id="tab2">
			...
			<!-- Adicionar -->
			<?php require 'pages/sistema/beacons/adicionar.php' ?>
			<!-- Adicionar -->
	...
	<div class="page-footer" id="page-footer">iTechMed 2017</div>
		...
		<script type="text/javascript" src="pages/sistema/beacons/index.js"></script>
		<!-- JS Files -->
