...
<html lang="pt-br">
	...
	<head>
		...
		<title>iTechMed - Sistema/Gateways</title>
	...
	<div class="page-content" id="page-content">
		...
		<div class="page-tab" id="tab1">
			...
			<!-- Listar -->
			<?php require 'pages/sistema/gateways/listar.php' ?>
			<!-- Listar -->
		...
		<div class="page-tab hide" id="tab2">
			...
			<!-- Adicionar -->
			<?php require 'pages/sistema/gateways/adicionar.php' ?>
			<!-- Adicionar -->
	...
	<div class="page-footer" id="page-footer">iTechMed 2017</div>
		...
		<script type="text/javascript" src="pages/sistema/gateways/index.js"></script>
		<!-- JS Files -->
