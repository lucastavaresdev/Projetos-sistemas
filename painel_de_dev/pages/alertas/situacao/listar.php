...
<div class="row">
		...
		<div class="box">
					...
					<div class="box-header" id="header1">
						...
						<i class="fa fa-question-circle"></i><i class="fa fa-spinner fa-spin hide"></i><i class="fa fa-exclamation-triangle hide"></i>
						<label>Situação Pendente</label>
						...
						<div class="table-responsive">
							...
							<thead>
									<tr>
										...
										<th onclick="setOrder(this, 9)">Setor de Origem</th>
										<th onclick="setOrder(this, 11)">Setor Atual</th>
										<th onclick="setOrder(this, 12)">Visto por Último</th>
										<th onclick="setOrder(this, 13)">Tempo</th>
									</tr>
								</thead>
								<tbody id="lista">
								</tbody>
