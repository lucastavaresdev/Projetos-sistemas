		...
		<div class="box">
			...
			<div class="box-content">
				...
				<div class="row">
					...
					<div class="col-6 xs">
						<div class="controle-box xs">
							<label class="controle-subtitle">Calibração</label>
							
							<form id="form4" data-tabid="4" autocomplete="off">
							
							<input type="hidden" id="command" name="command" value="atualizar_calibracao" />
							<input type="hidden" id="id" name="id" value="" />
							...
							<button type="submit" class="button controle-button"><label>Atualizar Calibração</label></button>
							<label id="box-status4" class="box-status sm hide" style="display:block">Status</label>
