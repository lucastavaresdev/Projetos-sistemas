	...
	<div class="col-12">
		...
		<div class="box">
			...
			<div class="box-header" id="header4">
				...
				<label>Relatório de Calibrações</label>
				...
				<div class="box-headerbutton right" onclick="listar()" ajax><i class="fa fa-16 fa-wrench"></i><label>Calibrações</label></div>
			...
			<div class="box-content">
				...
				<div class="table-responsive">
					...
					<thead>
							<tr>
							<th width="100px"></th>
							<th onclick="setOrder(this, 4)">Data da Calibração</th>
