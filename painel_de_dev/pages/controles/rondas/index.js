...
// Database
//=========================================================================================
_database = 'pages/controles/rondas/database.php';
_upload		= 'pages/controles/rondas/uploads/';
...
function editar(tabid, i) {
	...
	if (tabid && i) {
		...
		var options = {
			...
			data: _data[i],
			command: 'atualizar',
			inputs: ['id', 'id_usuario', 'id_equipamento', 'ronda_ultima', 'situacao', 'observacao']
		}
...
function controle(tabid, i) {
	...
	var form3 = byid('form3');
		if (form3) {
			...
			form3.id.value = _data[i].id_equipamento;
