		...
		<div class="box">
			...
			<div class="box-content">
				...
				<form id="form2" autocomplete="off">
					...
					<div class="row">
						<div class="col-2 formlabel lg">Última Ronda</div>
						<div class="col-4 formcontrol lg"><input type="datetime-local" id="ronda_ultima" name="ronda_ultima" value="" required /></div>
