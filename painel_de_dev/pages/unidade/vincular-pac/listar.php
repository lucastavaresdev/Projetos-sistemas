	...
	<div class="col-10 col-offset-1 lg">
		...
		<div class="box">
			...
			<div class="box-header" id="header1">
				...
				<i class="fa fa fa-calendar"></i><i class="fa fa-spinner fa-spin hide"></i><i class="fa fa-exclamation-triangle hide"></i>
				...
				<div class="table-responsive">
					...
					<input id="order" type='hidden'/>
						<thead>
							<tr>
								<th></th>
								<th onclick="setOrder(this, 2)">Data de Agendamento</th>
								<th onclick="setOrder(this, 3)">Paciente</th>
								<th onclick="setOrder(this, 5)">Data de Nascimento</th>
								<th class="center">Vinculo</th>
							</tr>
						</thead>
					<tbody id="lista">
					</tbody>
