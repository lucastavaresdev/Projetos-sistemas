...
function card_com_informacoes_do_setores(data) {
    ...
    for (i = 0; i < data.length; i++) {
        html += " <div class='col s12 l4' >"
                    ...
                    + "</p>"
                    + "<p>Aguardando:"
                    + "<b class='right con_card_aguardando'>" + se_null(data[i].aguardando_final) + "</b>"
                    + "</p>"
                    + "<p>Em atendimento:"
                    + "<b class='right'>" + se_null(data[i].atendimento_final) + "</b>"
                    + "</p>"
                    + "<p>Cancelados:"
                    + "<b class='right'>" + se_null(data[i].cancelado_final) + "</b>"
                    + "</p>"
                    + "<p>Finalizados:"
                    + "<b class='right'>" + se_null(data[i].finalizado_final) + "</b>"
                    + "</p>"
                    + "</div>"
                    + "</div></a>"
            + "</div>";
